...
const saleSteps = [
  {
    step: "1",
    label: "Prospecção",
    desc: "Identificação de potenciais clientes em nichos com presença digital fraca ou inconsistente.",
  },
  {
    step: "2",
    label: "Qualificação",
    desc: "Perguntas diretas: a empresa já possui site? Como chegam os clientes hoje? Existe investimento em presença digital?",
  },
  {
    step: "3",
    label: "Diagnóstico",
    desc: "Identificação de: ausência de estrutura digital, perda de credibilidade, dependência excessiva de redes sociais.",
  },
  {
    step: "4",
    label: "Apresentação",
    desc: 'Condução da conversa usando o posicionamento: "Trabalhamos com…"',
  },
  {
    step: "5",
    label: "Proposta",
    desc: "Apresentação do serviço adequado com base no catálogo oficial.",
  },
  {
    step: "6",
    label: "Fechamento",
    desc: "Encaminhamento para início do projeto.",
  },
  {
    step: "7",
    label: "Direcionamento",
    desc: "Cliente aprovado segue para execução técnica.",
  },
];
...
export default function KitDeGuerra() {
  return (
    <div className="space-y-8 md:space-y-10">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        >
          ...
          <p className="text-foreground text-sm font-semibold leading-relaxed">
            O foco não é estética isolada. O foco é presença digital que
            transmite credibilidade e aumenta a capacidade de aquisição de
            clientes.
          </p>
        </motion.div>
        ...
        >
          ...
          <blockquote className="text-muted-foreground text-sm leading-relaxed italic">
            ...
            <br />
            <br />
            A ideia não é apenas ter um site, mas estruturar a presença digital
            da empresa para que ela passe mais confiança, seja encontrada com
            mais facilidade e consiga gerar mais oportunidades de forma
            consistente.
            <br />
            <br />
            Atendemos principalmente empresas que já estão em operação, mas
            ainda não possuem uma estrutura digital profissional ou estão
            perdendo oportunidades por isso."
          </blockquote>
        </motion.div>
      </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {[
            ...
            },
            {
              ...
              title: "Problema",
              body: [
                "Falta de site profissional",
                "Dependência apenas de Instagram ou indicação",
                "Presença digital fraca ou desatualizada",
                "Perda de credibilidade em processos de decisão",
              ],
              isList: true,
            },
            {
            ...
            },
            {
              ...
              body: [
                ...
                "Estrutura digital completa de presença online",
              ],
              isList: true,
            },
            {
              ...
              body: [
                ...
                "Melhor posicionamento digital",
                "Estrutura profissional de aquisição de clientes",
              ],
              isList: true,
            },
            {
      ...
      {/* ── Tabela de Serviços (exata do /orcamentos) ── */}
      <motion.div
        variants={fadeUp}
        initial="hidden"
        animate="visible"
      ...
      >
        ...
        <p className="text-xs text-muted-foreground mt-3 text-right">
          * Utilize os valores e serviços disponíveis no{" "}
          <a
            href="/orcamentos"
            ...
            {[
              {
                ...
                value: "1/3 (33,33%) por projeto fechado",
              },
              {
                label: "Pagamento",
                value: "Após confirmação do pagamento do cliente",
              },
              ...
              <div
                key={i}
                className="flex justify-between items-start gap-4 text-sm py-2 border-b border-border/40 last:border-0"
              >
